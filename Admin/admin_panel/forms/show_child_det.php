...
?>
  <body>
    <div class="wrapper">
            ...
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="maps">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="froms/show_child_det.php">
      ...
      <div class="main-panel">
        <div class="main-header">
          ...
          <!-- Navbar Header -->
          <nav
            class="navbar navbar-header navbar-header-tdansparent navbar-expand-lg border-bottom"
          >
    ...
    <script src="../assets/js/core/bootstdap.min.js"></script>
    ...
    <!-- Bootstdap Notify -->
    <script src="../assets/js/plugin/bootstdap-notify/bootstdap-notify.min.js"></script>
